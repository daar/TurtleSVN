...
resourcestring
  ...
  rsTurtleSVNDiff = '%s - TurtleSVN Diff ...';
  rsTurtleSVNLog = '%s - TurtleSVN Log ...';
  rsTurtleSVNUpdate = '%s - TurtleSVN Update ...';
...
procedure ExecuteSvnCommand(ACommand: String; RepositoryPath: string; AFile: String);
